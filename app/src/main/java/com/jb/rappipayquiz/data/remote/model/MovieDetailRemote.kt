package com.jb.rappipayquiz.data.remote.model
...
data class MovieDetailRemote (
    ...
    @SerializedName("production_companies") val production_companies : List<ProductionCompaniesRemote>?,
...
data class ProductionCompaniesRemote (
    @SerializedName("id") val id : Int,
